    ...
    id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
        ...
        className='w-64 sm:w-80 rounded-3xl max-w-none'>
          <Image src={assets.Programmer} alt='user image' className='w-full rounded-3xl' />
        </motion.div>
       ...
       transition={{duration: 0.6, delay: 0.8}}
        className='flex-1'>
          <p className='mb-10 max-w-2xl font-poppins'>
            ...
            UI/UX, pengembangan web, dan pengembangan aplikasi mobile. Saya selalu
            bersemangat untuk belajar dan mengembangkan keterampilan saya di dunia
