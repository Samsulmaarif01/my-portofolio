  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <p className="mb-10 max-w-2xl font-poppins text-justify">
            Saya adalah mahasiswa semester 5 yang sangat antusias dalam bidang
            UI/UX, pengembangan web, dan pengembangan aplikasi mobile. Saya
            selalu bersemangat untuk belajar dan mengembangkan keterampilan saya
            di dunia teknologi yang terus berkembang ini.
          </p>
